...
public final class RefClass {
    ...
    static {
        try {
            ...
            REF_TYPES.put(RefStaticLong.class, RefStaticLong.class.getConstructor(Class.class, Field.class));
            REF_TYPES.put(RefStaticFloat.class, RefStaticFloat.class.getConstructor(Class.class, Field.class));
            REF_TYPES.put(RefStaticDouble.class, RefStaticDouble.class.getConstructor(Class.class, Field.class));
            REF_TYPES.put(RefStaticBoolean.class, RefStaticBoolean.class.getConstructor(Class.class, Field.class));
